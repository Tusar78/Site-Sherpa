...
export const ProblemSection = ({ className, style }) => {
  return (
    <section className={`w-full overflow-x-hidden bg-transparent px-4 py-[60px] sm:px-6 sm:py-[80px] md:px-8 lg:px-0 lg:py-[114px] ${className ?? ''}`.trim()} style={style} aria-labelledby="problem-heading">
